...
LOCAL_APPS = (
    ...
    "app_modules.credit_memo",
    "app_modules.reports",
    "app_modules.expanse_management",
)
...
MIDDLEWARE = [
    ...
    "app_modules.base.middleware.CustomMiddleware",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "app_modules.order.context_processors.get_google_map_api_key",
            ],
            "libraries": {
